...
// Declare app level module which depends on services (and filters if we had any)
var app = angular.module('myApp', ["ngResource"]).
  config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
    ...
    $routeProvider
      ...
      .when("/employees/new/:depId", { templateUrl: "partials/edit.jade", controller: "EmployeesEditCtrl" })
      .when("/employees/:id", { templateUrl: "partials/show.jade", controller: "EmployeesShowCtrl" })
      .when("/employees/department/:id", { templateUrl: "partials/showDepartment.jade", controller: "EmployeesDepartmentCtrl" })
